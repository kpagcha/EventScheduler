...
public class TeamTest {
	...
	public void constructorTest() {
		...
		Team team1 = new Team("Team 1", new HashSet<Player>(Arrays.asList(player1, player2)));
	...
	public void constructorNullNameTest() {
		...
		new Team(null, new HashSet<Player>(Arrays.asList(new Player("John Smith"), new Player("Jane Doe"))));
	}
	...
	public void constructorLessThanTwoPlayersTest() {
		...
		new Team("Team", new HashSet<Player>(Arrays.asList(new Player("Jane Doe"))));
	}
	...
	public void constructorNullPlayerTest() {
		...
		new Team("Team", new HashSet<Player>(Arrays.asList(null, new Player("Jane Doe"))));
	}
	...
	public void toStringTest() {
		...
		Team team1 = new Team("Team", new HashSet<Player>(Arrays.asList(player1, player2)));
