...
public abstract class Schedule {
	...
	public List<Match> getMatchesByPlayer(Player player) {
		List<Match> playerMatches = new ArrayList<Match>();
	...
	public List<Match> getMatchesByLocalization(Localization localization) {
		List<Match> localizationMatches = new ArrayList<Match>();
		for (Match match : matches)
	...
	/**
	 * Devuelve el conjunto de partidos que tienen lugar en cualquiera de las
	 * localizaciones de juego
	 * 
	 * @param localizations
	 *            localizaciones para las que se quiere obtener la lista de
	 *            partidos
	 * @return lista de partidos, <code>null</code> si la lista de partidos aún
	 *         no ha sido calculada
	 */
	 ...
	 * 
	 * @param scheduleArray
	 *            array que representa un horario
