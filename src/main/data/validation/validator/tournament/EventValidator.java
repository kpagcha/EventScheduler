 ...
 * <li>El número de <i>timeslots</i> disponibles debe ser mayor o igual que el número de partidos por jugador multiplicado por la duración de un partido
 * </ul>
 * 
 ...
 * <li>El número de jugadores que componen cada enfrentamiento debe ser el esperado, es decir, el número de jugadores por partido especificado por el evento
 * </ul>
 * 
