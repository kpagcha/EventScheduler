...
/**
 * Excepción que indica que el formato del cuerpo JSON no es esperado, es decir, campos obligatorios que no están
...
public class MalformedJsonException extends IOException {
    ...
    /**
     * Construye una excepción de JSON malformado con el mensaje especificado
     *
