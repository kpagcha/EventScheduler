 ...
 * <p>
 * <p>Es una representación abstracta que puede ser un jugador entendido como individuo, es decir, un deportista, una
 * persona, un competidor o un participante, así como un conjunto de individuos que, en términos del modelo
 * deportivo, representar un sujeto único que compite, siendo el ejemplo más claro el de un equipo de jugadores.</p>
 * <p>
